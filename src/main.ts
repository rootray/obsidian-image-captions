...
import { buildImageViewPlugin } from './ImageViewPlugin'
...
export default class ImageCaptions extends Plugin {
  ...
  async onload () {
    ...
    // Register the new ViewPlugin for Live Preview functionality
    this.registerEditorExtension(buildImageViewPlugin(this));
